...
COMMON_LIB_DEPS = obj/object.o obj/sdlib/gc.o obj/sdlib/rt.o obj/sdlib/stdc.o \
	obj/sdlib/sync.o obj/sdlib/platform.o $(LIBSDRT_PLATFORM_OBJ)
...
check-sdlib-platform: $(CHECK_LIBSDRT_PLATFORM)

check-sdlib: check-sdlib-gc check-sdlib-rt check-sdlib-stdc check-sdlib-sync check-sdlib-platform
