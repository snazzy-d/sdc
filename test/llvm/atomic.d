...
// CHECK: [[RET:%[a-z0-9\.]+]] = load atomic i32, i32* {{.*}} seq_cst, align 4
// CHECK: ret i32 [[RET]]
}
...
// CHECK: store atomic i32 %arg.n, i32* {{.*}} seq_cst, align 4
}
...
// CHECK: [[CMPXCHG:%[a-z0-9\.]+]] = cmpxchg i32* {{.*}}, i32 0, i32 %arg.n seq_cst seq_cst, align 4
...
// CHECK: [[CMPXCHG:%[a-z0-9\.]+]] = cmpxchg weak i32* {{.*}}, i32 0, i32 %arg.n seq_cst seq_cst, align 4
// CHECK: [[RET:%[a-z0-9\.]+]] = extractvalue { i32, i1 } [[CMPXCHG]], 1
// CHECK: ret i1 [[RET]]
}
