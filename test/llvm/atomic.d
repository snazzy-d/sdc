...
uint doFetchSub(shared Atomic!uint* x, uint n) {
	return x.fetchSub(n);
	// CHECK-LABEL: _D6atomic10doFetchSubFMOPOS4sync1d6atomic6AtomicTTkZ6AtomickZk
...
uint doFetchAnd(shared Atomic!uint* x, uint n) {
	return x.fetchAnd(n);
	// CHECK-LABEL: _D6atomic10doFetchAndFMOPOS4sync1d6atomic6AtomicTTkZ6AtomickZk
...
uint doFetchOr(shared Atomic!uint* x, uint n) {
	return x.fetchOr(n);
	// CHECK-LABEL: _D6atomic9doFetchOrFMOPOS4sync1d6atomic6AtomicTTkZ6AtomickZk
...
uint doFetchXor(shared Atomic!uint* x, uint n) {
	return x.fetchXor(n);
	// CHECK-LABEL: _D6atomic10doFetchXorFMOPOS4sync1d6atomic6AtomicTTkZ6AtomickZk
