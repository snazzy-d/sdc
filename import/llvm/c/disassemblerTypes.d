...
module llvm.c.disassemblerTypes;
 ...
 */
alias LLVMOpInfoCallback = int function(void* DisInfo, ulong PC, ulong Offset,
                                        ulong OpSize, ulong InstSize,
...
struct LLVMOpInfoSymbol1 {
  ulong Present;      /* 1 if this symbol is present */
  const(char)* Name;  /* symbol name if not NULL */
  ulong Value;        /* symbol value if name is NULL */
};
...
enum LLVMDisassembler_ReferenceType_Out_Objc_CFString_Ref = 4;
/* The output reference is to a Objective-C message. */
enum LLVMDisassembler_ReferenceType_Out_Objc_Message = 5;
/* The output reference is to a Objective-C message ref. */
enum LLVMDisassembler_ReferenceType_Out_Objc_Message_Ref = 6;
